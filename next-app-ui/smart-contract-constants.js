export const CryptoDevsNFTAddress =
  "0x84ff29630dF1F9735A7157cdf7F782D22Bd111fa";
export const FakeNFTMarketplaceAddress =
  "0x307ea11a4670288a532A6d54A8A1665243Ff58A7";
export const CryptoDevsDAOAddress =
  "0xb58F2234C7edd2760c5FEc16B855C5907fcD6be6";
...
export const CryptoDevsDAOABI = [
  {
    inputs: [
      { internalType: "address", name: "_fakeNFTMarketplace", type: "address" },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "declinedVotes", type: "uint256" },
      { internalType: "bool", name: "isPropsalExecuted", type: "bool" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "_proposalIndex", type: "uint256" },
      { internalType: "enum CryptoDevsDAO.Vote", name: "_vote", type: "uint8" },
    ],
    name: "voteOnProposal",
    outputs: [],
    stateMutability: "nonpayable",
